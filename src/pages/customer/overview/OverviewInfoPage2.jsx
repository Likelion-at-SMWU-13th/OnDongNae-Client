...
import marketImage from '@/assets/img-market-big-itaewon.png'
    ...
    <div>
      ...
      <C.Main>
        <C.Scroll className='scrollable'>
          ...
          <TitleWrapper>{t('overview.itaewonMarket')}</TitleWrapper>
          <InfoWrapper>
            <LocationIcon src={locationIcon} alt='위치 아이콘'></LocationIcon>
            <AdressInfo>{t('overviewInfo.adress2')} </AdressInfo>
          </InfoWrapper>
          <InfoWrapper>
            <PhoneIcon src={phoneIcon} alt='전화 아이콘'></PhoneIcon>
            <AdressInfo>{t('overviewInfo.call2')} </AdressInfo>
          </InfoWrapper>
          <KakaoMapContainer
          ...
          <InfoContent>{t('overviewInfo.Introduction2')}</InfoContent>
          <InfoTitle>{t('overviewInfo.characteristics')}</InfoTitle>
          <InfoContent>{t('overviewInfo.characteristics2')}</InfoContent>
          <CommonInfoWrapper>
          ...
          <InfoContent>{t('overviewInfo.eventAndActivities2')}</InfoContent>
        </C.Scroll>
      </C.Main>
      <CustomerBottomNav />
    </div>
...
export default OverviewInfoPage2
