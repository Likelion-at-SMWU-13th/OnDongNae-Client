...
import marketImage from '@/assets/img-market-big-yongmun.png'
    ...
    <div>
      ...
      <C.Main>
        <C.Scroll className='scrollable'>
          ...
          <TitleWrapper>{t('overview.YongmunMarket')}</TitleWrapper>
          <InfoWrapper>
            <LocationIcon src={locationIcon} alt='위치 아이콘'></LocationIcon>
            <AdressInfo>{t('overviewInfo.adress1')} </AdressInfo>
          </InfoWrapper>
          <InfoWrapper>
            <PhoneIcon src={phoneIcon} alt='전화 아이콘'></PhoneIcon>
            <AdressInfo>{t('overviewInfo.call1')} </AdressInfo>
          </InfoWrapper>
          <KakaoMapContainer
          ...
          <InfoContent>{t('overviewInfo.Introduction1')}</InfoContent>
          <InfoTitle>{t('overviewInfo.characteristics')}</InfoTitle>
          <InfoContent>{t('overviewInfo.characteristics1')}</InfoContent>
          <CommonInfoWrapper>
            <LocationIcon src={restroomIcon} alt='화장실 아이콘'></LocationIcon>
            <AdressInfo>{t('overviewInfo.restroomAvailable')} </AdressInfo>
          </CommonInfoWrapper>
          <CommonInfoWrapper>
          ...
          <InfoContent>{t('overviewInfo.eventAndActivities1')}</InfoContent>
        </C.Scroll>
      </C.Main>
      <CustomerBottomNav />
    </div>
...
export default OverviewInfoPage1
