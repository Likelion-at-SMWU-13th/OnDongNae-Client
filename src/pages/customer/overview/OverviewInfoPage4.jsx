...
import marketImage from '@/assets/img-market-big-manly.png'
    ...
    <div>
      ...
      <C.Main>
        <C.Scroll className='scrollable'>
          ...
          <TitleWrapper>{t('overview.manlyMarket')}</TitleWrapper>
          <InfoWrapper>
            <LocationIcon src={locationIcon} alt='위치 아이콘'></LocationIcon>
            <AdressInfo>{t('overviewInfo.adress4')} </AdressInfo>
          </InfoWrapper>
          <InfoWrapper>
            <PhoneIcon src={phoneIcon} alt='전화 아이콘'></PhoneIcon>
            <AdressInfo>{t('overviewInfo.call4')} </AdressInfo>
          </InfoWrapper>
          <KakaoMapContainer
          ...
          <InfoContent>{t('overviewInfo.Introduction4')}</InfoContent>
          <InfoTitle>{t('overviewInfo.characteristics')}</InfoTitle>
          <InfoContent>{t('overviewInfo.characteristics4')}</InfoContent>
          <CommonInfoWrapper>
          ...
          <InfoContent>{t('overviewInfo.eventAndActivities4')}</InfoContent>
        </C.Scroll>
      </C.Main>
      <CustomerBottomNav />
    </div>
